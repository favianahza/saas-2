...
<h1 class="text-center f-poppins mt-0 mb-2">Data Siswa</h1>
	<div class="row mt-3">
		<div class="col mx-auto">
			<img src="<?= base_url().'img/siswa/'.$student['foto'] ?>" class="d-block mx-auto rounded-circle shadow">
		</div>
		...
		<div class="col my-auto">
			<table class="w-100">
				...
				<tr>
					...
					<td><h5>:</h5></td>
					<?php if( $student["pembimbing"] == NULL ) : ?>
					<td><h5><span class="badge badge-danger">BELUM DIMASUKAN</h5></td>
					<?php else: ?>
				...
				<tr>
					<td><h5><span class="badge badge-secondary h-100" id="back" style="cursor: pointer;">KEMBALI</h5></td>
					<td></td>
					<td></td>
				</tr>
...
<script type="text/javascript">
	$('#back').on('click', function() {
		...
		$('#content').load('http://'+window.location.host+'/SaaS-2/index.php/pembimbing/data_siswa', function(status,xhr) {
			if(xhr=="error"){
