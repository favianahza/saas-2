		...
		<h1 class="text-center f-poppins mt-0 mb-2">Data Siswa</h1>
			<div class="row mt-3">
				<div class="col mx-auto">
					<img src="<?= base_url().'img/siswa/'.$student["foto"] ?>" class="d-block mx-auto rounded-circle shadow" width="450" height="450">
				</div>
				<div class="col my-auto">
					<table class="w-100">
						...
						<tr>
							...
							<td><h5><span class="badge badge-danger">BELUM DISETUJUI</h5></td>
							<?php else: ?>
							<td><h5><span class="badge badge-success">SUDAH DISETUJUI</h5></h5></td>
							<?php endif; ?>
						</tr>
