  ...
  <div class="row it">
    <div class="col-sm-offset-1 col-sm-10 mx-auto" id="one">
      <p><i class="fa fa-file"></i> Format File : 'pdf', 'jpg', 'jpeg', dan 'png'.</p>
        ...
        <?php elseif($acc["tgl_pkl"] == NULL || $acc["tgl_pkl"] == NULL): ?>
          <p data-deadline="<?= $acc["tgl_pkl"] ?>" style="display: none;" id="dl"></p>
        <?php else: ?>
...
<?php if( $count == 0 ) : ?>
<script type="text/javascript" src="<?= base_url().'js/upload_file.js' ?>"></script>
<?php endif; ?>
